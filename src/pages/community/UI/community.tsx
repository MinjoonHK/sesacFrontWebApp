              ...
              >
                ...
                >
                  <img
                    ...
                    alt="이미지를 표시할수 없습니다"
                  />
                  <span style={{ color: "#FF6161" }}>{data.like}</span>
                  <img
                    src="/img/comment.svg"
                    alt="이미지를 표시할수 없습니다"
                  />{" "}
                  <span style={{ color: "#3561FF" }}>{data.comment}</span>
                </div>
              </div>
            );
          })}
...
const CommunityData = [
  ...
  {
    title: "2분기 청년자립수당 지원금",
    content: `언제 발표하는지 아시는 분 합격하면 개별 문자로 오나요?`,
    like: `3`,
    comment: `2`,
  },
  {
    title: "토익 스터디 해본사람",
    content: `알바 하면서 토익 공부하려고 하는데 혼자 하는 것보다는 다같이하는게 나을 것 같아서 스터디 하려는데 혹시 분위기 어떤가요`,
    like: `5`,
    comment: `7`,
  },
  {
  ...
  {
    title: "수원 쪽 쉐어하우스 구했는데",
    content: `알바하는 곳이랑 쉐어하우스가 너무 멀어서 고민입니다.`,
    like: `0`,
    comment: `11`,
  },
  {
